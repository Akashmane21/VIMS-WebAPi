...
namespace Vims_Webapi.Controllers
{
    ...
    public class VehiclesController : ControllerBase
    {
        ...
        public VehiclesController(ContextDB context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Vehicles>> PostVehicles(Vehicles vehicles)
        {
          if (_context.Vehicles == null)
          {
              return Problem("Entity set 'ContextDB.Vehicles'  is null.");
          }
            _context.Vehicles.Add(vehicles);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetVehicles", new { id = vehicles.Vehicles_id }, vehicles);
        }
        ...
        {
            return (_context.Vehicles?.Any(e => e.Vehicles_id == id)).GetValueOrDefault();
        }
    }
}
